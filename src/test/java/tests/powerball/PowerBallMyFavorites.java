...
public class PowerBallMyFavorites extends BaseTest {
    ...
    @Test
    @DisplayName("QAAUT-1579 :: My Favorites | Favorite Playslips | Max Favorite Number of PowerBall Games")
    public void QAAUT$1579$MyFavoritesFavoritePlayslipsMaxFavoriteNumberOfPowerBallGames(WebDriver webDriver) {
        ...
        powerBallGamesManualPlay.clickQuickPicksButtonUnderNumbersSection();
        String numberOfDraws = powerBallGamesManualPlay.getNumberOfDraws().replace("x ", "");
        ...
        for (Integer i = 0; i < numOfGames; i++) {
            powerBallGamesManualPlay.clickAddToFavoritesButton();
