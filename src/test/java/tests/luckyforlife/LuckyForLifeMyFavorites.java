...
public class LuckyForLifeMyFavorites extends BaseTest {
    ...
    @Test
    @DisplayName("QAAUT-1581 :: My Favorites | Favorite Playslips | Max Favorite Number of LuckyForLife Games")
    public void QAAUT$1581$MyFavoritesFavoritePlayslipsMaxFavoriteNumberOfLuckyForLifeGames(WebDriver webDriver) {
        ...
        luckyForLifeGamesManualPlay.clickQuickPicksButtonUnderNumbersSection();
        String numberOfDraws = luckyForLifeGamesManualPlay.getNumberOfDraws().replace("x ", "");
        ...
        for (Integer i = 0; i < numOfGames; i++) {
            luckyForLifeGamesManualPlay.clickAddToFavoritesButton();
