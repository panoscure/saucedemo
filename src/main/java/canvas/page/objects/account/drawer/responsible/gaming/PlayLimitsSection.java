...
public class PlayLimitsSection {
    WebDriver webDriver;

    public PlayLimitsSection(WebDriver webDriver) {
    ...
    public String getDailyPlayLimitAmount() {
    ...
    public BigDecimal getDailyLimitLeftToPlay(){
        String dailyLimitFullText = SeleniumWaits.visibilityOfElementLocated(webDriver,
                ...
                .getText();
        String dailyLimit = dailyLimitFullText.substring(1, dailyLimitFullText.indexOf("Left to play")-1)
                .replace(",", "");
        return new BigDecimal(dailyLimit);
    }

    public BigDecimal getWeeklyLimitLeftToPlay(){
        String weeklyLimitFullText = SeleniumWaits.visibilityOfElementLocated(webDriver,
                ...
                .getText();
        String weeklyLimit = weeklyLimitFullText.substring(1, weeklyLimitFullText.indexOf("Left to play")-1)
                .replace(",", "");
        return new BigDecimal(weeklyLimit);
    }

    public BigDecimal getMonthlyLimitLeftToPlay(){
        String monthlyLimitFullText = SeleniumWaits.visibilityOfElementLocated(webDriver,
                ...
                .getText();
        String monthlyLimit = monthlyLimitFullText.substring(1, monthlyLimitFullText.indexOf("Left to play")-1)
                .replace(",", "");
    ...
    public String getDailyIncreasedPlayLimitAmount() {
    ...
    public BigDecimal getDailyPlayLimitAsBigDecimal(String depositLimit) {
    ...
    public PlayLimitsSection clickChangePlayLimitsButton() {
        WebElement changeDepositLimitsBtn = SeleniumWaits.elementToBeClickable(webDriver,
                By.xpath("//button[text()='Change Play limits']"));
    ...
    public String getNewIncreasedPlayLimitOfYourAccount() {
    ...
    public String getNewIncreasedPlayLimitDate() {
        WebElement newDepositLimit = SeleniumWaits.visibilityOfElementLocated(webDriver,
