...
public class Race2RichesMyFavorites extends BaseTest {
    ...
    @Test
    @DisplayName("QAAUT-1582 :: My Favorites | Favorite Playslips | Max Favorite Number of Race2Riches Games")
    public void QAAUT$1582$MyFavoritesFavoritePlayslipsMaxFavoriteNumberOfRace2RichesGames(WebDriver webDriver) {
        ...
        String numberOfDraws = race2RichesGamesManualPlay.getNumberOfRaces().replace("x ", "");
        ...
        for (Integer i = 0; i < numOfGames; i++) {
            race2RichesGamesManualPlay.clickAddToFavoritesButton();
