...
public class DC4QuickPicks extends BaseTest {
    ...
    @Test
    @DisplayName("QAAUT-1517 :: DC4 Game Client | Quick Pick tab | 1 Play Straight $0.50")
    public void QAAUT$1517$DC4GameClientQuickPickTab1PlayStraight$050(WebDriver webDriver) {
        ...
        //assert quick pick DC4 page elements
        ...
        assertWithMessage("DC4 game option is incorrect")
    ...
    @Test
    @DisplayName("QAAUT-1518 :: DC4 Game Client | Quick Pick tab | 2 Play $2.00")
    public void QAAUT$1518$DC4GameClientQuickPickTab2PlayStraight$200(WebDriver webDriver) {
        HomePage homePage = new HomePage(webDriver);
        BigDecimal accountBalance = homePage.getBalance();
        homePage.clickLinkInTopMenu("GAMES");
    ...
    @Test
    @DisplayName("QAAUT-1519 :: DC4 Game Client | Quick Pick tab | 5 Play Straight $2.50")
    public void QAAUT$1519$DC4GameClientQuickPickTab5PlayStraight$250(WebDriver webDriver) {
        HomePage homePage = new HomePage(webDriver);
        BigDecimal accountBalance = homePage.getBalance();
        homePage.clickLinkInTopMenu("GAMES");
    ...
    @Test
    @DisplayName("QAAUT-1520 :: DC4 Game Client | Quick Pick tab | 2 Play $1.00")
    public void QAAUT$1520$DC4GameClientQuickPickTab2PlayStraight$100(WebDriver webDriver) {
        HomePage homePage = new HomePage(webDriver);
        BigDecimal accountBalance = homePage.getBalance();
        homePage.clickLinkInTopMenu("GAMES");
    ...
    @Test
    @DisplayName("QAAUT-1522 :: DC4 Game Client | Quick Pick tab | 1 Play Straight $1.00")
    public void QAAUT$1522$DC4GameClientQuickPickTab1PlayStraight$100(WebDriver webDriver) {
        HomePage homePage = new HomePage(webDriver);
        BigDecimal accountBalance = homePage.getBalance();
        homePage.clickLinkInTopMenu("GAMES");
    ...
    @Test
    @DisplayName("QAAUT-1523 :: DC4 Game Client | Quick Pick tab | 5 Play Straight $5.00")
    public void QAAUT$1523$DC4GameClientQuickPickTab5PlayStraight$500(WebDriver webDriver) {
        HomePage homePage = new HomePage(webDriver);
        BigDecimal accountBalance = homePage.getBalance();
        homePage.clickLinkInTopMenu("GAMES");
