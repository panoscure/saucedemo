...
public class DC5MyFavorites extends BaseTest {
    ...
    @Test
    @DisplayName("QAAUT-1578 :: My Favorites | Favorite Playslips | Max Favorite Number of DC5 Games")
    public void QAAUT$1578$MyFavoritesFavoritePlayslipsMaxFavoriteNumberOfDC5Games(WebDriver webDriver) {
    ...
    @Test
    @DisplayName("QAAUT-1584 :: My Favorites | Favorite Playslips | Add a DC5 Straight(00000) & Multiplier $1.00 Game")
    public void QAAUT$1584$MyFavoritesFavoritePlayslipsAddADC5Straight00000Multiplier1Game(WebDriver webDriver) {
        ...
        assertWithMessage("incorrect game")
                .that(myFavoriteCoupons.getGameDetail("Game").equalsIgnoreCase("DC-5"))
                .isTrue();
    ...
    @Test
    @DisplayName("QAAUT-1586 :: My Favorites | Favorite Playslips | Edit a DC5 Straight Game | Add a Quick Play")
    public void QAAUT$1586$MyFavoritesFavoritePlayslipsEditADC5StraightGameAddAQuickPlay(WebDriver webDriver) {
