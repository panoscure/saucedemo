...
public class ShoppingCartLoggedOutUserCheckout extends BaseTest {
    ...
    @Test
    @DisplayName("QAAUT-1695 :: Shopping Cart | Checkout button functionality - Logged Out User")
    public void QAAUT$1695$ShoppingCartCheckoutButtonFunctionalityLoggedOutUser(WebDriver webDriver) {
        ...
        assertWithMessage("incorrect page game")
                .that(megaMillionsGamesManualPlay.isGamePageCorrect("megamillions.id"))
                .isTrue();
