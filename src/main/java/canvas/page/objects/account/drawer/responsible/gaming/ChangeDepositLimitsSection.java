...
public class ChangeDepositLimitsSection {

    WebDriver webDriver;

    public ChangeDepositLimitsSection(WebDriver webDriver) {
        this.webDriver = webDriver;
    }


    public ChangeDepositLimitsSection clickDropdownArrow() {
    ...
    public ChangeDepositLimitsSection selectOptionFromDailyLimitDropdown(String dailyLimitSelectDropdownOptionToBeSelected) {
    ...
    public ChangeDepositLimitsSection selectOptionFromWeeklyLimitDropdown(String weeklyLimitSelectDropdownOptionToBeSelected) {
    ...
    public ChangeDepositLimitsSection selectOptionFromMonthlyLimitDropdown(String monthlyLimitSelectDropdownOptionToBeSelected) {
    ...
    public ChangeDepositLimitsSection setDailyLimit(String dailyLimitToBeSet) {
    ...
    public ChangeDepositLimitsSection setWeeklyLimit(String weeklyLimitTobeSet) {
        SeleniumWaits.visibilityOfElementLocated(webDriver,
    ...
    public ChangeDepositLimitsSection setMonthlyLimit(String monthlyLimitTobeSet) {
        SeleniumWaits.visibilityOfElementLocated(webDriver,
    ...
    public ChangeDepositLimitsSection clickSetLimitsButton() {
    ...
    public ChangeDepositLimitsSection clickYesSetLimitsButtonInModal() {
    ...
    public ChangeDepositLimitsSection clickBackToDepositLimitButton() {
        SeleniumWaits.elementToBeClickable(webDriver, By.xpath("//button[text()='Back to Deposit Limits']")).click();
        return this;
    }
